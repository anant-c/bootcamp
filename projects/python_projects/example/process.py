...
# Load default configurations from a .env file
load_dotenv()
...
def transform_line(line: str, mode: str) -> str:
    ...
    if mode == "uppercase":
        ...
        # This case is handled defensively, but Typer's validation should prevent it.
...
def process(
    ...
    # 2. Transform each line according to the specified mode using a generator
    transformed_lines = (transform_line(line, mode) for line in lines_iterator)

    # 3. Write the results to the output destination
